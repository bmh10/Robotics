...
task main()
{
  while (true) {
   ...
   motor[motorC] = -FORWARD_SPEED;                   //motor C is run at a -75 power level
   motor[motorB] = -FORWARD_SPEED;                   //motor B is run at a -75 power level
